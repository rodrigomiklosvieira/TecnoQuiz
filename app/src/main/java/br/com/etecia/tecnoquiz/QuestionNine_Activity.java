...
public class QuestionNine_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.questionnine_layout);
    }
    ...
    public void nextQ(View view) {
        ...
        if (correta.isChecked()) {
            ...
            Intent intent = new Intent(QuestionNine_Activity.this, QuestionTen_Activity.class);
