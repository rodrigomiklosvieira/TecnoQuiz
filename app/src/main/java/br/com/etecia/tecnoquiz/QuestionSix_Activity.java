...
public class QuestionSix_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.questionsix_layout);
    }
    ...
    public void nextQ(View view) {
        ...
        if (correta.isChecked()) {
            ...
            Intent intent = new Intent(QuestionSix_Activity.this, QuestionSeven_Activity.class);
