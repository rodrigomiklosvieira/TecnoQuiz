...
public class QuestionTen_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.questionten_layout);
    }
    ...
    public void nextQ(View view) {
        ...
        if (correta.isChecked()) {
            ...
            Intent intent = new Intent(QuestionTen_Activity.this, QuestionEleven_Activity.class);
