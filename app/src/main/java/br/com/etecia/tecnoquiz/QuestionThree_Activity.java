...
public class QuestionThree_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.questionthree_layout);
    }
    ...
    public void nextQ(View view) {
        ...
        if (correta.isChecked()) {
            ...
            Intent intent = new Intent(QuestionThree_Activity.this, QuestionFour_Activity.class);
