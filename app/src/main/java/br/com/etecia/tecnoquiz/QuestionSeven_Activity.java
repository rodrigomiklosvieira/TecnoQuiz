...
public class QuestionSeven_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.questionseven_layout);
    }
    ...
    public void nextQ(View view) {
        ...
        if (correta.isChecked()) {
            ...
            Intent intent = new Intent(QuestionSeven_Activity.this, QuestionEight_Activity.class);
